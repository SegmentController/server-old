...
module.exports =
{
  ...
  SRVCOM_MASTER_REPORT_NIGHTSTATECHANGE: 0x01,
  SRVCOM_MASTER_CONTROL_NIGHTSTATE: 0x01,
  SrvCom_Master_Report_NightStateChange: new struct(undefined,
    [
      'address', struct.uint8_t(),
      'command', struct.uint8_t(),
      'state', struct.uint8_t(),
    ]),
  SrvCom_Master_Control_NightState: new struct(undefined,
    [
      'address', struct.uint8_t(),
      'command', struct.uint8_t(),
      'state', struct.uint8_t(),
  ...
  SRVCOM_KEYPAD_CONTROL_TONE: 0x01,
  ...
  SrvCom_Keypad_Control_Tone: new struct(undefined,
    [
      'address', struct.uint8_t(),
      'command', struct.uint8_t(),
      'toneA', struct.int8_t(),
  ...
  SRVCOM_AMBIENTLIGHT_REPORT_LIGHTSTATECHANGE: 0x02,
  SRVCOM_AMBIENTLIGHT_REPORT_EFFECTSTATECHANGE: 0x03,
  SRVCOM_AMBIENTLIGHT_CONTROL_LIGHTSTATE: 0x01,
  SRVCOM_AMBIENTLIGHT_CONTROL_EFFECTSTATE: 0x02,
